...
class ProductDetailsControllerImp extends ProductDetailsController {
  ...
  intialData() async {
    ...
    countitems = await getCountItems(
        itemsModel.itemsId.toString(), itemsModel.itemsPrice.toString());
    statusRequest = StatusRequest.success;
    update();
  }

  getCountItems(String itemsid, String cartitemsprice) async {
    statusRequest = StatusRequest.loading;
  ...
  addItems(String itemsid, String cartitemsprice) async {
    statusRequest = StatusRequest.loading;
    update();
  ...
  add() {
    addItems(itemsModel.itemsId!.toString(), itemsModel.itemsPrice.toString());
    countitems++;
    update();
  }
