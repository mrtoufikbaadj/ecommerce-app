...
import 'package:justappecommerce/view/widget/orders/dialograting.dart';

class CardOrderListArchive extends GetView<ArchiveOrdersController> {
            ...
            Row(
              children: [
                ...
                if (listdata.ordersRating == 0)
                  MaterialButton(
                    onPressed: () {
                      showDialoRating(context, listdata.ordersId.toString());
                    },
                    color: AppColor.secondColor,
                    textColor: Colors.white,
                    child: Text("Rating"),
